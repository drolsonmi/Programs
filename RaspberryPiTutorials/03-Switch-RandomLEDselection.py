...
selected_program = input("Do you want Random (1) or Ordered (2) lights? ")
#print("You selected ",selected_program)
...
#   print("In the Random Generator routine")
    while True:
...
#   print("In the Ordered Generator routine")
    while True:
        previous_state = input_state
        input_state = GPIO.input(SwitchPin)
        if (previous_state == True and input_state == False):
